...
execute unless data block ~ ~ ~ {Items:[{Slot:2b,id:"minecraft:player_head",Count:1b}]} run scoreboard players set @s bank-page-id 8
...
execute as @p store success score @p bank-data run clear @p player_head{BankID:1b}
execute if score @p bank-data matches 1 run data modify entity @s data.ItemID set from block 0 -64 0 Items[0]
...
execute as @p store success score @p bank-data run clear @p player_head{BankID:2b}
execute if score @p bank-data matches 1 run data modify entity @s data.ItemID set from block 0 -64 0 Items[1]
execute if score @p bank-data matches 1 run scoreboard players set @s bank-page-id 12
execute if score @p bank-data matches 1 run playsound block.iron_door.open master @p ~ ~ ~ 1 1.5 1
execute if entity @a[scores={bank-data=1..},limit=1] run scoreboard players reset @a bank-data

execute as @p store success score @p bank-data run clear @p player_head{BankID:3b}
execute if score @p bank-data matches 1 run data modify entity @s data.ItemID set from block 0 -64 0 Items[2]
execute if score @p bank-data matches 1 run scoreboard players set @s bank-page-id 12
execute if score @p bank-data matches 1 run playsound block.iron_door.open master @p ~ ~ ~ 1 1.5 1
execute if entity @a[scores={bank-data=1..},limit=1] run scoreboard players reset @a bank-data

execute as @p store success score @p bank-data run clear @p player_head{BankID:4b}
execute if score @p bank-data matches 1 run data modify entity @s data.ItemID set from block 0 -64 0 Items[3]
execute if score @p bank-data matches 1 run scoreboard players set @s bank-page-id 12
execute if score @p bank-data matches 1 run playsound block.iron_door.open master @p ~ ~ ~ 1 1.5 1
execute if entity @a[scores={bank-data=1..},limit=1] run scoreboard players reset @a bank-data

execute as @p store success score @p bank-data run clear @p player_head{BankID:5b}
execute if score @p bank-data matches 1 run data modify entity @s data.ItemID set from block 0 -64 0 Items[4]
execute if score @p bank-data matches 1 run scoreboard players set @s bank-page-id 12
execute if score @p bank-data matches 1 run playsound block.iron_door.open master @p ~ ~ ~ 1 1.5 1
execute if entity @a[scores={bank-data=1..},limit=1] run scoreboard players reset @a bank-data
