...
execute unless data block ~ ~ ~ {Items:[{Slot:0b,id:"minecraft:player_head",Count:1b}]} run scoreboard players set @s bank-page-id 8
...
execute as @p store success score @p bank-data run clear @p player_head{BankID:11b}
execute if score @p bank-data matches 1 run data modify entity @s data.ItemID set from block 0 -64 0 Items[10]
...
execute as @p store success score @p bank-data run clear @p player_head{BankID:12b}
execute if score @p bank-data matches 1 run data modify entity @s data.ItemID set from block 0 -64 0 Items[11]
execute if score @p bank-data matches 1 run scoreboard players set @s bank-page-id 12
execute if score @p bank-data matches 1 run playsound block.iron_door.open master @p ~ ~ ~ 1 1.5 1
execute if entity @a[scores={bank-data=1..},limit=1] run scoreboard players reset @a bank-data

execute as @p store success score @p bank-data run clear @p player_head{BankID:13b}
execute if score @p bank-data matches 1 run data modify entity @s data.ItemID set from block 0 -64 0 Items[12]
execute if score @p bank-data matches 1 run scoreboard players set @s bank-page-id 12
execute if score @p bank-data matches 1 run playsound block.iron_door.open master @p ~ ~ ~ 1 1.5 1
execute if entity @a[scores={bank-data=1..},limit=1] run scoreboard players reset @a bank-data

execute as @p store success score @p bank-data run clear @p player_head{BankID:14b}
execute if score @p bank-data matches 1 run data modify entity @s data.ItemID set from block 0 -64 0 Items[13]
execute if score @p bank-data matches 1 run scoreboard players set @s bank-page-id 12
execute if score @p bank-data matches 1 run playsound block.iron_door.open master @p ~ ~ ~ 1 1.5 1
execute if entity @a[scores={bank-data=1..},limit=1] run scoreboard players reset @a bank-data

execute as @p store success score @p bank-data run clear @p player_head{BankID:15b}
execute if score @p bank-data matches 1 run data modify entity @s data.ItemID set from block 0 -64 0 Items[14]
execute if score @p bank-data matches 1 run scoreboard players set @s bank-page-id 12
execute if score @p bank-data matches 1 run playsound block.iron_door.open master @p ~ ~ ~ 1 1.5 1
execute if entity @a[scores={bank-data=1..},limit=1] run scoreboard players reset @a bank-data